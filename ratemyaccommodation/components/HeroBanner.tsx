    ...
    <div className="flex flex-col-reverse md2:flex-row items-center justify-between mx-auto max-w-7xl h-full md:mb-0 mb-8">
      <div className="flex-1 px-4 xl:px-0 mx-auto max-w-7xl">
        <div className="flex flex-col">
          ...
          <h1 className="font-bold tracking-normal text-4xl md:text-5xl text-grey5">Find the best accommodation <span className="text-blue">without the hassle</span></h1>
          </div>
        </div>
        <div className="list-disc">
          <p>Bullet point one</p>
        </div>
        <div className="flex flex-col md:flex-row md:space-x-2 space-x-0 md:space-y-0 space-y-2 py-4 md:mr-1 items-center">
          <a href="" target="_blank" rel="noreferrer">
            <motion.button
              
              className="justify-center object-center text-center font-medium text-base rounded h-12 lg:w-60 w-full px-4"
