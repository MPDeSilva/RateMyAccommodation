...
const Search = () => {
  ...
  <div className="flex justify-center items-center mx-auto h-screen bg-cover bg-center">
    <div className="flex flex-col justify-center mx-auto space-y-5">
      <p className="text-white font-bold text-5xl text-center items-center">Find your ideal <span className="text-gray-800">Accommodation</span></p>
      <p className="text-white font-bold text-3xl text-center items-center">From <span className="text-gray-800">Students</span> who have reviewed it</p>
      <p className="text-white  font-bold text-lg text-center items-center">From the <span className="text-gray-800">University</span> you are going to</p>
