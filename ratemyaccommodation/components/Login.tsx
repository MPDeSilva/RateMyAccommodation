        ...
        <div className="bg-white max-w-xl max-w-md w-full rounded-2xl space-y-8 py-12 mx-4 px-4 sm:px-6 lg:px-8">
          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-700 hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
